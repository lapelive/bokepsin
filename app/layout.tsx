...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepsin.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "logo": "https://bokepsin.pages.dev/favicon.ico",
        "url": "https://bokepsin.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepsin.pages.dev"
        ...
        "url": "https://bokepsin.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokepsin.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepsin.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepsin.pages.dev/?q={search_term}", 
